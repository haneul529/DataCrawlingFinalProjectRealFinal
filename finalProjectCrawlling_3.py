...
# 강의 데이터 수집
courses = driver.find_elements(By.CSS_SELECTOR, 'body > div.category-app > div:nth-child(6) > div > div')  # 선택자 수정
if not courses:
    print("강의 정보를 찾을 수 없습니다. 선택자를 확인하세요.")
    # 페이지 HTML 저장
    html = driver.page_source
    with open("debug_page.html", "w", encoding="utf-8") as f:
        f.write(html)
    print("HTML 구조를 debug_page.html 파일로 저장했습니다.")
    driver.quit()
    exit()
...
file_name = "fastcampus_courses_datascience_with_links.csv"
